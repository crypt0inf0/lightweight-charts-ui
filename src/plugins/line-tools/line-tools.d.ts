 ...
 */
export type ActionType = "add" | "delete" | "modify";
/**
...
declare class HistoryManager {
	 ...
	 */
	recordAdd(tool: any, toolType: ToolType): void;
	/**
	 ...
	 */
	recordModify(tool: any, toolType: ToolType, prevState: ToolState): void;
	/**
...
export declare class LineToolManager extends PluginBase {
	 ...
	 */
	deleteTool(tool: any, skipHistory?: boolean): void;
	/**
	 * Handle tool selection when clicking in edit mode
	 */
	private _handleToolSelection;
	/**
